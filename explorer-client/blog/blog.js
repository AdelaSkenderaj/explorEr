document.addEventListener("DOMContentLoaded", function () {
  ...
  const authorsList = [
    ...
    },
    {
      ...
      pictureUrl: "../images/alejandro.jpg",
      description:
  ...
  const blogPhotoUrl = document.getElementById("blogImg")
  const authorField = document.getElementById("author");
  const authorPhotoUrl = document.getElementById("authorImg")
