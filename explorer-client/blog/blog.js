  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    const blogs = [
      {
        "id":1,
        "title":"The Significance of Erasmus for Students: Unlocking a World of Possibilities",
        "tags": ["Erasmus program", "study abroad", "personal growth", "academic development", "cultural enrichment"],
        "blogAuthorID": 1,
      ...
      {
        "id":2,
        "tags": ["foreign language", "language learning", "personal growth", "cognitive abilities", "career prospects", "cultural appreciation"],
        "title": "Embracing the Power of Learning Foreign Languages: Unlocking New Horizons",
        "blogAuthorID": 1,
      ...
      {
        "id":3,
        "title": "The Beauty of Embracing Different Cultures: A Student's Perspective",
        "tags": ["different cultures", "horizons", "preconceived notions", "biases", "open-mindedness", "empathy"],
        "blogAuthorID": 2,
      ...
      {
        "id":4,
        "title": "The Ultimate Guide to Making the Most of Your Erasmus Exchange Experience",
        "tags": ["different cultures", "horizons", "preconceived notions", "biases", "open-mindedness", "empathy"],
        "blogAuthorID": 2,
      ...
      {
        "id":5,
        "title": "Finding Your Home Away from Home: Creating a Sense of Belonging During Your Erasmus Exchange",
        "tags": ["Erasmus exchange", "sense of belonging", "power of connections", "host city exploration", "stay connected with roots", "cozy living space"],
        "blogAuthorID": 3,
      ...
      const authorsList = [
        {
          ...
          "description": "Emma is an adventurous and curious student studying International Relations at the University of Manchester. With a passion for exploring new cultures and embracing diverse perspectives, she embarked on an Erasmus exchange program to broaden her horizons and gain valuable international experience."
        },
        {
          "id": 2,
          ...
          "description": "Alejandro is a dynamic and ambitious student pursuing a degree in Economics at the Universidad de Buenos Aires. As part of his study abroad program, he ventured beyond his home country's borders to immerse himself in different academic systems and enhance his understanding of global economic dynamics."
        },
        {
          "id": 3,
          "name": "Sofia Müller",
      ...
      document.getElementById('blogContent').innerText = blog.text
      ...
      const AuthorCurrBlog = authorsList.find(author => author.id === blog.blogAuthorID);
